...
public class IsuScholarshipPaidFragment extends ConnectedFragment<IsuScholarshipPaidFragmentPresenter> {
    ...
    @Override
    protected IsuScholarshipPaidFragmentPresenter getPresenter() {
        return presenter;
    }

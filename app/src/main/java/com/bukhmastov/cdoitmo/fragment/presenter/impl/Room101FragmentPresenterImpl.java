...
public class Room101FragmentPresenterImpl implements Room101FragmentPresenter, SwipeRefreshLayout.OnRefreshListener, Room101ReviewBuilder.register {
    ...
    private void addRequest() {
        thread.runOnUI(() -> {
            ...
            if (App.OFFLINE_MODE) {
                ...
                staticUtil.lockOrientation(activity, true);
                final View room101_close_add_request = fragment.container().findViewById(R.id.room101_close_add_request);
                final LinearLayout room101_back = fragment.container().findViewById(R.id.room101_back);
                final LinearLayout room101_forward = fragment.container().findViewById(R.id.room101_forward);
                final TextView room101_back_text = fragment.container().findViewById(R.id.room101_back_text);
                final TextView room101_forward_text = fragment.container().findViewById(R.id.room101_forward_text);
                final ProgressBar progressBar = fragment.container().findViewById(R.id.room101_progress_bar);
    ...
    private void display() {
        thread.runOnUI(() -> {
            ...
            try {
                ...
                TextView room101_limit = fragment.container().findViewById(R.id.room101_limit);
                TextView room101_last = fragment.container().findViewById(R.id.room101_last);
                TextView room101_penalty = fragment.container().findViewById(R.id.room101_penalty);
                ...
                final LinearLayout room101_review_container = fragment.container().findViewById(R.id.room101_review_container);
                ...
                // работаем со свайпом
                SwipeRefreshLayout mSwipeRefreshLayout = fragment.container().findViewById(R.id.room101_review_swipe);

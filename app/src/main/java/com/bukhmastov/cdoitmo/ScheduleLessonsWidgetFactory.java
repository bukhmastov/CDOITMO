    ...
    public void onDataSetChanged() {
        ...
        try {
            ...
            switch (Calendar.getInstance().get(Calendar.DAY_OF_WEEK)){
                case Calendar.MONDAY: dayNumber = 1; break;
                case Calendar.TUESDAY: dayNumber = 2; break;
                case Calendar.WEDNESDAY: dayNumber = 3; break;
                case Calendar.THURSDAY: dayNumber = 4; break;
                case Calendar.FRIDAY: dayNumber = 5; break;
                case Calendar.SATURDAY: dayNumber = 6; break;
                case Calendar.SUNDAY: dayNumber = 7; break;
            }
            ...
            for (int i = 0; i < schedule.length(); i++){
                ...
                if (day.getInt("number") == dayNumber){

...
public class Room101TimeEndPickParser extends Parser<Room101Request> {

    public Room101TimeEndPickParser(@NonNull String html) {
        super(html);
    }
    ...
    protected Room101Request doParse(TagNode root) {
        ...
        room101Request.setType("time_end_pick");
    ...
    protected String getTraceName() {
        return FirebasePerformanceProvider.Trace.Parse.ROOM_101_TIME_END_PICK;
    }
}
